class Api::V1::CurrentUserController < Api::V1::ApiController
  ...
  private
    def user_params
      strong_params = params.require(:user).permit(:allow_direct_messages, :banner_picture, :birthday, :country_code, :email, :first_name, :last_name, :middle_name, :phone_number, :profile_picture, :username, language_ids: [])
