class ApplicationController < ActionController::Base
  ...
  protected
    def configure_permitted_parameters
      devise_parameter_sanitizer.permit(:sign_up, keys: [:birthday, :country_id, :email, :first_name, :invited_by_user_id, :last_name, :phone_number, :profile_picture, :security_question_answer, :username, :user_security_question_id])
