module Tasks
  class AwsMediaLiveApi
    ...
    # Input methods
    def self.create_input(stream_access_token='access-token-2')
      input_security_group = create_input_security_group()
    ...
    # Chanel methods
    def self.create_channel(stream_access_token='access-token-2')
      media_store_endpoint = Tasks::AwsMediaStoreApi.get_container&.endpoint
      if media_store_endpoint.blank?
        # Error here
        return
      end
      
      # input_to_attach = create_input(stream_access_token)
      # if input_to_attach.blank?
      #   # Error here
      #   return
      # end
